...
### Логика поведения
**Фокус при открытии**
- При открытии окна фокус на первом интерактивном элементе
- Если интерактивных элементов, кроме кнопок, нет (окно подтверждения действия), фокус на кнопку, помеченную атрибутом `[data-focus]`
